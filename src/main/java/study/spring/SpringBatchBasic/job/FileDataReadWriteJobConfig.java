...
import study.spring.SpringBatchBasic.domain.player.Player;
import study.spring.SpringBatchBasic.domain.player.PlayerFieldSetMapper;
import study.spring.SpringBatchBasic.domain.player.PlayerYears;
...
public class FileDataReadWriteJobConfig {
    ...
    public Step fileReadWriteStep(
            ...
            FlatFileItemWriter<PlayerYears> playerItemWriter) {
